    ...
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                ...
                <Form v-bind="PreferenceController.update.form()" class="space-y-6" v-slot="{ errors, processing, recentlySuccessful }">
                    <!-- Custom Instructions -->
                    <div class="grid gap-2">
                        <Label for="instruction_prompt">Custom instructions</Label>
                        <p class="text-sm text-muted-foreground">
                            Add custom instructions that will be included in all your conversations. This helps the AI understand your preferences and context
                            better.
                        </p>
                        <Textarea
                            ...
                            :rows="5"
                            :max-lines="15"
                            class="rounded-lg border-2 border-input p-2"
                        />
                        <p class="text-xs text-muted-foreground">Maximum 5000 characters</p>
                        <InputError class="mt-2" :message="errors.instruction_prompt" />
                    </div>

                    <div class="flex items-center gap-4">
                        <Button class="cursor-pointer" :disabled="processing" data-test="update-preferences-button">Save preferences</Button>
