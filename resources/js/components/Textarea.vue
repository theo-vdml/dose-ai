...
const baseClasses = 'block w-full resize-none border-0 bg-transparent text-base focus:ring-0 focus:outline-none';

const mergedClass = computed(() => twMerge(baseClasses, attrs.class as string));
