/**
* ScrollLockContainer Component
*
* A smart scroll container that automatically scrolls to the bottom when new content is added,
* but respects user intent by locking scroll position when the user manually scrolls up.
*
* This is particularly useful for chat interfaces, logs, or any streaming content where you want
...
<template>
    ...
    <div ref="container">
        ...
        <div ref="content" class="w-full h-fit">
