                ...
                <div class="flex-1 space-y-3">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            ...
                            <p class="text-sm text-zinc-400">
                                Conformité AI Act & Transparence
                            </p>
                        </div>
                        <button @click="dismiss" class="text-zinc-400 hover:text-white transition-colors"
                    ...
                    <div class="space-y-2 text-sm text-zinc-300">
                        <div class="flex items-start gap-2">
                            ...
                            <p>
                                <strong class="text-white">Hallucinations possibles :</strong> Les réponses peuvent
                                contenir des informations
                                inexactes. Vérifiez toujours les informations importantes.
                            </p>
                        </div>
                        <div class="flex items-start gap-2">
                            <span class="text-amber-500 mt-0.5">⚠️</span>
                            <p>
                                <strong class="text-white">Ne remplace pas un professionnel :</strong> Ce système ne
                                peut se substituer à
                                l'avis d'un médecin, avocat ou autre professionnel qualifié.
                            </p>
                        </div>
                        <div class="flex items-start gap-2">
                            <span class="text-blue-500 mt-0.5">ℹ️</span>
                            <p>
                                <strong class="text-white">Confidentialité :</strong> Ne partagez jamais d'informations
                                sensibles
                                (mots de passe, données bancaires, informations médicales).
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="pt-2">
                        <Link href="/mentions-legales#ai-compliance"
                            class="text-sm text-blue-400 hover:text-blue-300 underline inline-flex items-center gap-1">
